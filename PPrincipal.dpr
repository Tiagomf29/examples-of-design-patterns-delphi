...
uses
  ...
  FighterLevel1 in 'abstractfactory\service\FighterLevel1.pas',
  FighterLevel2 in 'abstractfactory\service\FighterLevel2.pas',
  UConexao in 'singleton\UConexao.pas',
  UConnection in 'monostate\UConnection.pas';
